...
/*
 * Modified by: Edison Fernández <edison.fernandez@ridgerun.com>
...
// CSI Tx PHY  (32-bit Registers)
  ...
  {0x014c, 0x00000001, 0x00000000, 4, 0},
  {0x0150, 0x00000001, 0x00000000, 4, 0},
...
static void tc358743_format_change(struct sensor_data *sd)
{
	...
	// sd->spix.swidth = tc358743_mode_info_data[td->fps][mode].width; /*TODO: EFA, testing*/
	// sd->spix.sheight = tc358743_mode_info_data[td->fps][mode].height;
	sd->pix.width = tc358743_mode_info_data[td->fps][mode].width;
	sd->pix.height = tc358743_mode_info_data[td->fps][mode].height;
	td->det_changed = 1;
			...
			const struct i2c_device_id *id)
{
	...
	// sensor->mipi_camera = 1; /*TODO: EFA, testing*/
	// sensor->virtual_channel = 0; /*TODO: EFA, testing*/
